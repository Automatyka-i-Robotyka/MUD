...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.985\textwidth]{./Screeny/analityczne3a.png}
    \label{fig:my_label}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.928\textwidth]{./Screeny/schematiwykres3a.png}
    \label{fig:my_label}
\end{figure}
\newpage
\begin{flushleft}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.928\textwidth]{./Screeny/anailtyczne3b.png}
    \label{fig:my_label}
\end{figure}
\begin{flushleft}
\newpage
